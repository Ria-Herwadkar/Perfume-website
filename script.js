    ...
    if (navAuthContainer) {
      ...
      if (loggedIn === "true") { // If the user is logged in
        ...
        navAuthContainer.innerHTML = `
          <span class="me-2 user">Welcome, ${username}!</span> // Display a welcome message with the user's email
          <button id="logoutButton" class="btn btn-outline-secondary logout">Logout</button> // Add a logout button
        `;
        ...
        navAuthContainer.innerHTML = `
          <a href="login.html" class="btn btn-outline-primary me-2 login-button">Login</a> // Add a login button
          <a href="register.html" class="btn btn-primary sign-up-button">Sign-up</a> // Add a sign-up button
        `;
      }
    }
  });
